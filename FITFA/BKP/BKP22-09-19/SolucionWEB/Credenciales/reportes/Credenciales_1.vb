...
Public Class Credenciales_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fitfa.Credenciales_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCredenciales_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Credenciales_1 = New Credenciales_1()
        rpt.Site = Me.Site
        Return rpt
    End Function
