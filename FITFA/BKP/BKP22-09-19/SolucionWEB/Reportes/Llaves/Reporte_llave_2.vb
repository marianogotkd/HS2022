...
Public Class Reporte_llave_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "fitfa.Reporte_llave_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_llave_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_llave_2 = New Reporte_llave_2()
        rpt.Site = Me.Site
        Return rpt
    End Function
